...
def main():
    ...
    image = load_image('my_frame.jpg')
    copy_image = load_image('my_frame.jpg')
    dest_image = load_image('sam_test_image_away.jpg')
    copy_dest_image = load_image('sam_test_image_away.jpg')
