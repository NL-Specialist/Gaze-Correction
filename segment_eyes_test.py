...
IMAGE_PATH = 'segment_test_image.jpg'
LEFT_EYE_OUTPUT_PATH = 'left_eye_output.jpg'
RIGHT_EYE_OUTPUT_PATH = 'right_eye_output.jpg'
WHITE_SQUARE_DIMENSIONS = (50, 25)
...
if __name__ == "__main__":
    process_image(IMAGE_PATH, LEFT_EYE_OUTPUT_PATH, RIGHT_EYE_OUTPUT_PATH)
